...
const std::string CLASSES[OUTPUT_CLS_SIZE]{ "background", "aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow", "diningtable", "dog",
"horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train", "tvmonitor", "aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow",
"diningtable", "dog", "horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train", "tvmonitor", "aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car",
"cat", "chair", "cow", "diningtable", "dog", "horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train", "tvmonitor", "aeroplane", "bicycle", "bird", "boat",
"bottle", "bus", "car", "cat", "chair", "cow", "diningtable", "dog", "horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train", "tvmonitor", "aeroplane",
"bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow", "diningtable", "dog", "horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train",
"tvmonitor", "aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow", "diningtable", "dog", "horse", "motorbike", "person", "pottedplant",
"sheep", "sofa", "train", "tvmonitor", "aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow", "diningtable", "dog", "horse", "motorbike",
"person", "pottedplant", "sheep", "sofa", "train", "tvmonitor", "aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow", "diningtable", "dog",
"horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train", "tvmonitor", "aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow",
"diningtable", "dog", "horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train", "tvmonitor", "aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car",
...
void jpg2ppm(const std::string& filename, PPM& ppm)
{
	...
	for (int j = 0; j < INPUT_H; j++) {
		...
		{
			ppm.buffer[(j * INPUT_H + i) * channel] = resized.data[(j * INPUT_H + i) * channel + 2] * 255;
			ppm.buffer[(j * INPUT_H + i) * channel + 1] = resized.data[(j * INPUT_H + i) * channel + 1] * 255;
			ppm.buffer[(j * INPUT_H + i) * channel + 2] = resized.data[(j * INPUT_H + i) * channel + 0] * 255;
		}
	}
}
...
int main(int argc, char** argv)
{
	...
	caffeToGIEModel("faster_rcnn_test_iplugin.prototxt",
		"vgg16_faster_rcnn_iter_300000.caffemodel",
	...
	for (int pn = 0; pn < M; ++pn)
	{
		...
		// unscale bick to raw image space
		for (int i = 0; i < N; ++i)
		{
		...
		for (int i = 0; i < N; ++i)
		{
			...
			for (int c = 1; c < OUTPUT_CLS_SIZE; ++c) // skip the background
			{
				...
				for (unsigned k = 0; k < indices.size(); ++k)
				{
					...
					result_file << ppms[i].fileName << " " << c << " " << scores[idx*OUTPUT_CLS_SIZE + c]
						<< " " << b.x1*ppms[i].w / 224 << " " << b.y1*ppms[i].h / 224 << " " \
						<< b.x2*ppms[i].w / 224 << " " << b.y2*ppms[i].h / 224 << std::endl;
					//<<  b.x2*ppms[i].w/image_scale/224 << " " <<  b.y2*ppms[i].h/224 << std::endl;
				}
			}
		}
	}
